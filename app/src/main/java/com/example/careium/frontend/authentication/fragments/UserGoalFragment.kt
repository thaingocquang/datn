    ...
    private fun handleClickButtons() {
        binding.finalRegister.setOnClickListener {
            ...
            when {
                ...
                binding.goalMaintainWeight.isChecked -> futureGoal = FutureGoal.MaintainWeight
            }
        ...
        binding.backIcon.setOnClickListener {
            activity?.supportFragmentManager?.beginTransaction()
                ?.replace(R.id.auth_frame, UserWorkoutLevelFragment.newInstance())
    ...
    private fun updateUserDataUI() {
        if (user.desiredWeight != 0f && user.futureGoal != null) {
            ...
            when (user.futureGoal) {
                ...
                FutureGoal.MaintainWeight -> binding.goalMaintainWeight.isChecked = true
                else -> {}
            }
        }
    }
